...
class WhatsAppConsoleResponse(BaseModel):
    ...
    Attributes:
        ...
        lookup_job_id: Optional job id for code lookup polling.
            ...
            every 4s up to 60s to get the final result. The executor
            normally completes the lookup within 55s to leave delivery
            margin for the final poll and Evolution response.
