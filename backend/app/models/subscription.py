...
class Subscription(Base, TimestampMixin):
    ...
    streaming_password_encrypted: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    profile_name: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    profile_pin_encrypted: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
...
class SubscriptionReminderSettings(Base, TimestampMixin):
    ...
    warning_days: Mapped[Any] = mapped_column(JSON, default=lambda: [7, 3, 1], server_default='[7, 3, 1]', nullable=False)
    reminder_time: Mapped[str] = mapped_column(String(5), default="09:00", server_default="09:00", nullable=False)
    recipient_mode: Mapped[str] = mapped_column(String(50), default="tenant_only", server_default="tenant_only", nullable=False)
