...
async def _handle_subscriptions_create_duration(self, phone, msg, session, session_service, tenant_id, db):
...
async def _handle_subscriptions_create_custom_date(self, phone, msg, session, session_service, tenant_id, db):
    del phone, tenant_id, db
...
async def _handle_subscriptions_create_confirm(self, phone, msg, session, session_service, tenant_id, db):
