...
KEY_SUBSCRIPTIONS_CREATE_SERVICE_PROMPT = (
    "wa.tenant.subscriptions.create.service_prompt"
)
...
KEY_SUBSCRIPTIONS_CREATE_PASSWORD_PROMPT = (
    "wa.tenant.subscriptions.create.password_prompt"
)
KEY_SUBSCRIPTIONS_CREATE_PASSWORD_CONFIRM_PROMPT = (
    "wa.tenant.subscriptions.create.password_confirm"
)
KEY_SUBSCRIPTIONS_CREATE_PASSWORD_MISMATCH = (
    "wa.tenant.subscriptions.create.password_mismatch"
)
KEY_SUBSCRIPTIONS_CREATE_PROFILE_NAME_PROMPT = (
    "wa.tenant.subscriptions.create.profile_name"
)
KEY_SUBSCRIPTIONS_CREATE_PROFILE_OPTION_PROMPT = (
    "wa.tenant.subscriptions.create.profile_option"
)
KEY_SUBSCRIPTIONS_CREATE_PIN_PROMPT = "wa.tenant.subscriptions.create.pin_prompt"
KEY_SUBSCRIPTIONS_CREATE_PIN_CONFIRM_PROMPT = (
    "wa.tenant.subscriptions.create.pin_confirm"
)
KEY_SUBSCRIPTIONS_CREATE_PIN_MISMATCH = "wa.tenant.subscriptions.create.pin_mismatch"
KEY_SUBSCRIPTIONS_CREATE_PIN_REQUIRES_PROFILE = (
    "wa.tenant.subscriptions.create.pin_requires_profile"
)
...
KEY_SUBSCRIPTIONS_CREATE_DUPLICATE_NOTICE = (
    "wa.tenant.subscriptions.create.duplicate_notice"
)
...
KEY_SUBSCRIPTIONS_EDIT_ERROR_INVALID_FIELD = (
    "wa.tenant.subscriptions.edit.invalid_field"
)
KEY_SUBSCRIPTIONS_EDIT_SUCCESS = "wa.tenant.subscriptions.edit.success"
KEY_SUBSCRIPTIONS_EDIT_PASSWORD_CONFIRM_PROMPT = (
    "wa.tenant.subscriptions.edit.password_confirm"
)
...
KEY_SUBSCRIPTIONS_REACTIVATE_DURATION_PROMPT = (
    "wa.tenant.subscriptions.reactivate.duration_prompt"
)
KEY_SUBSCRIPTIONS_REACTIVATE_CUSTOM_DATE_PROMPT = (
    "wa.tenant.subscriptions.reactivate.custom_date"
)
KEY_SUBSCRIPTIONS_REACTIVATE_CONFIRM_TEMPLATE = (
...
KEY_SUBSCRIPTIONS_RENEW_DURATION_PROMPT = (
    "wa.tenant.subscriptions.renew.duration_prompt"
)
