...
| **Catalog Price** | Precio opcional de un Plan, siempre interpretado en la Currency del Tenant. `NULL` significa "Precio a consultar" (sin precio publicado). No existe conversión ni precio por moneda. |
