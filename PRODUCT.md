...
## Product Purpose
Trackpal is a multi-tenant platform for WhatsApp-based service delivery, streaming-account subscription management, and mailbox code retrieval. It exists to centralize tenant/client operations, keep WhatsApp console flows aligned with REST/dashboard workflows, and reduce manual handling of access codes, subscription status, and tenant support.

## Brand Personality
Calm operator: precise, reliable, quietly confident, and task-focused. The UI should feel like a dependable operations console, not a marketing demo.

## Anti-references
Avoid generic SaaS-card aesthetics: gradient hero text, repeated metric-card scaffolds, decorative dashboards, startup-template polish, and visual effects that do not improve operator confidence or task completion.
