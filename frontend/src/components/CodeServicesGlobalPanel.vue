    ...
    <template v-else-if="services.length">
      ...
      <div class="flex justify-end">
        <button
          ...
          :disabled="isSaving"
          @click="saveServices"
          class="px-4 py-2 bg-primary hover:bg-primary/90 active:bg-primary/80 disabled:bg-primary/50 text-primary-foreground text-sm font-medium rounded-md shadow-sm transition-colors cursor-pointer disabled:cursor-not-allowed"
        >
