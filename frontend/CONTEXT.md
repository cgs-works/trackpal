...
| **Gmail Setup Assistant** | Two-step Settings experience for connecting the Central Lookup Mailbox. It guides the Tenant Admin to create a Google app password before requesting the Gmail address and generated credential; an optional **Google Connection** alternative may appear. Avoid exposing **IMAP**, server, port, or SSL terminology. |
