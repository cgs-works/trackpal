...
Multi-tenant platform for managing WhatsApp-based service delivery. The Master operator manages production Tenants through the web dashboard and WhatsApp, plus bounded Starter/Pro Demo Account evaluations through the web dashboard. Tenant Admins use plan-aware Web and WhatsApp interfaces for profile, WhatsApp linking, mailbox code retrieval, code-service selection, and access control; Pro adds clients, catalog, subscriptions, reminders, and Public API Catalog.
